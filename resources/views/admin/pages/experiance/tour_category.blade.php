        ...
        <tbody class="table-border-bottom-0" >
          @foreach ($lists as $key => $cat)
            <tr>
                ...
                <td>
                    <a href="{{ URL::To('admin/experiance/category/edit', $cat->id) }}"><i class="fa fa-solid fa-pen-to-square"></i></a>
                    <a href="{{ URL::To('admin/experiance/category/delete', $cat->id) }}" onclick="deleteConfirmation(event)"><i class="fa fa-solid fa-trash"></i></a>
                </td>
            </tr>
          @endforeach
