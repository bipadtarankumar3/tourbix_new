                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-floating form-floating-outline mb-4">
                                        ...
                                        <select id="smallSelect" name="location" class="form-select form-select-sm">
                                        @foreach ($locations as $location)
                                        <option value="{{$location->location_name}}" @if(strtolower($hotel->location)==strtolower($location->location_name)) selected @endif >{{$location->location_name}}</option>
                                        @endforeach
                                    </select>
