...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <form action="{{ isset($room) ? url('vendor/room/save_room/' . $room->id) : url('vendor/room/save_room') }}" method="POST" enctype="multipart/form-data" class="browser-default-validation">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href="{{URL::to('vendor/room/list')}}">
...
<script>
    ...
    function remove_row_with_data(get_this,id) {
        ...
        $.ajax({
            type: "GET",
            url: "{{URL::to('vendor/room/delete_room_images/')}}"+"/"+id,// where you wanna post
            data: {
                'id':''
            },
