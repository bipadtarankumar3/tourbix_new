        ...
        <div class="row">
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ isset($roomType) ? URL::to('vendor/room/type/update/' . $roomType->id) : URL::to('vendor/room/type/add-action') }}" method="post">
                            @csrf
                                ...
                                <tbody class="table-border-bottom-0">
                                    @foreach ($roomTypes as $key => $roomType)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ URL::to('vendor/room/type/edit', $roomType->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                                <a href="{{ URL::to('vendor/room/type/delete', $roomType->id) }}" onclick="deleteConfirmationGet(event)"><i class="fa-solid fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
